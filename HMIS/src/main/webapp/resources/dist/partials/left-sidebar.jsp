...
<!-- LOGO -->
      ...
      <ul class="metismenu side-nav">
		 ...
		 <!--- 공지사항관리  -->
         <li class="side-nav-item"><a href="/admin/notice/list"
            class="side-nav-link"> <i
               class=" mdi mdi-star-outline"></i> <span
               class="badge badge-success float-right"></span> <span> 공지사항</span>
         </a></li>
         ...
         <li class="side-nav-item"><a href="/admin/mis/list"
            class="side-nav-link"> <i
               ...
               class="badge badge-success float-right"></span> <span> MIS-DAY
                  출결</span>
         </a></li>
         ...
         <li class="side-nav-item"><a href="javascript: void(0);"
            class="side-nav-link"> <i class="mdi mdi-tablet"></i> <span
               class="badge badge-success float-right"></span> <span> 참여 프로그램</span>
               <span class="menu-arrow"></span>
         </a>
            <ul class="side-nav-second-level" aria-expanded="false">
               <li><a href="/admin/program/list">참여 프로그램 목록</a></li>
               <li><a href="/admin/userprogram/list">참여 프로그램 신청자 목록</a></li>
            </ul></li>
         ...
         <li class="side-nav-item"><a href="javascript: void(0);"
            class="side-nav-link"> <i class="mdi mdi-school"></i> <span
               class="badge badge-success float-right"></span> <span> 학과 졸업심사</span> <span
               class="menu-arrow"></span>
         </a>

            <ul class="side-nav-second-level" aria-expanded="false">
               <li><a href="/admin/graduation/list">학과 졸업심사</a></li>
      	...
      	<!--- 학생 e-포트폴리오  -->
         <li class="side-nav-item"><a href="/admin/portfolio/list"  class="side-nav-link"> 
         <i class=" mdi mdi-clipboard-text"></i> <span
               class="badge badge-success float-right"></span> <span> 학생 e-포트폴리오</span>
         </a></li>

		 <!--- 취업 공고 관리  -->
         <li class="side-nav-item"><a href="/admin/announcement/list"  class="side-nav-link"> 
