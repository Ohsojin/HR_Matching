                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="/admin/posting/list?page=${cri.page}&perPageNum=${cri.perPageNum}&searchType=${cri.searchType}&keyword=${cri.keyword}">채용공고 목록</a></li>
...
<c:forEach items="${recommandDTO}" var="recommandDTO" varStatus="Status">
                                       ...
                                       <div class="inbox-widget">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="/resources/dist/assets/images/users/avatar-2.jpg" class="rounded-circle" alt=""></div>
                                                <p class="inbox-item-author">
                                                	<a href='/admin/portfolio/read?page=${cri.page}&perPageNum=${cri.perPageNum}&searchType=${cri.searchType}&keyword=${cri.keyword}read${pageMaker.makeSearch(pageMaker.cri.page)}&userNo=${recommandDTO.userNo}&userName=${recommandDTO.userName}'>
                                                		${recommandDTO.userName}
                                                	</a>
                                                </p>
                                                <p class="inbox-item-text">${recommandDTO.userNo}</p>
                                                <p class="inbox-item-date">
                                                    <a href="#" class="btn btn-sm btn-link text-info font-13"> ${recommandDTO.recommand} </a>
                                                </p>
                                            </div>
                                            ...
                                            <table class="table table-hover table-centered mb-0">
                                                ...
                                                <c:if test="${!empty list}">
													<c:forEach items="${list}" var="list" varStatus="listStat">
	                                                    <tr>
	                                                        <td><a href='/admin/posting/read?page=${cri.page}&perPageNum=${cri.perPageNum}&searchType=${cri.searchType}&keyword=${cri.keyword}&postingId=${list.postingId}'> ${list.jobName}</a></td>
