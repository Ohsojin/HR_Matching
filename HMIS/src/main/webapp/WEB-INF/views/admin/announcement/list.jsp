							...
							<div class="page-title-box">
								<div class="page-title-right">
									<ol class="breadcrumb m-0">
										...
										<li class="breadcrumb-item active">취업공고</li>
									</ol>
								</div>
								<h4 class="page-title">취업공고 목록</h4>
							</div>
						</div>
					</div>
												...
												<c:if test="${!empty list}">
													<c:forEach items="${list}" var="list" varStatus="listStat">
														...
														<c:if test="${pageMaker.cri.page != 1 }">
															...
															<td>${list.job}</td>
															<td>${list.compArea}</td>
																<td><a class="action-icon" href="recommandlist${pageMaker.makeSearch(pageMaker.cri.page)}&annNo=${list.annNo}">
																<i class="mdi mdi-human-child"></i></a></td>
														</tr>
													</c:forEach>
												</c:if>
